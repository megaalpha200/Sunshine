...
//  TODO DONE(5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
    public static final int CODE_WEATHER = 100;
    public static final int CODE_WEATHER_WITH_DATE = 101;

//  TODO DONE(7) Instantiate a static UriMatcher using the buildUriMatcher method
    private static final UriMatcher sUriMatcher = buildUriMatcher();

    WeatherDbHelper mOpenHelper;

//  TODO DONE(6) Write a method called buildUriMatcher where you match URI's to their numeric ID
...
//  TODO DONE(1) Implement onCreate
    @Override
    public boolean onCreate() {
//      TODO DONE(2) Within onCreate, instantiate our mOpenHelper
        mOpenHelper = new WeatherDbHelper(getContext());

//      TODO DONE(3) Return true from onCreate to signify success performing setup
        return true;
    }
...
//  TODO DONE(8) Provide an implementation for the query method
    /**
...
//      TODO DONE(9) Handle queries on both the weather and weather with date URI
        SQLiteDatabase weatherDb = mOpenHelper.getReadableDatabase();

        Cursor cursor;

        switch (sUriMatcher.match(uri)) {
            case CODE_WEATHER:
                cursor = weatherDb.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                cursor = weatherDb.query(WeatherContract.WeatherEntry.TABLE_NAME, projection, WeatherContract.WeatherEntry.COLUMN_DATE + "=?", selectionArgs, null, null, sortOrder);
                break;
            default:
                throw new UnsupportedOperationException("Unsupported URI: " + uri);
        }

//      TODO DONE(10) Call setNotificationUri on the cursor and then return the cursor
